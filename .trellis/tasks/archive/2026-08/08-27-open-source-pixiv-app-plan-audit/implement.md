...
2. 审查认证、网络/分页、共享 mutation、Reverse Image、Profile、Novel、下载/Ugoira、History/Settings、Widgets、Updater 与 Live 源码和测试；网络额外比较 DoH/direct connector、failure classification 与关闭证书校验的反例。
