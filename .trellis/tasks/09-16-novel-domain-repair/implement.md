...
- [ ] `test(novel): webview 正文提取器与 detail 合并的失败测试`——fixture + 提取器 + fetchDetail 双源合并测试，先红
- [ ] `fix(novel): 正文改走 /webview/v2/novel 内嵌 JSON`——fetchWebText + 提取器 + fetchDetail 合并；阅读器可渲染真实正文；内嵌图片按 §2.2 裁定落地或占位
