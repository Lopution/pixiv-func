...
// These functions are ignored because they are not marked as `pub`: `build_ech_tls_config`, `build_root_store`, `collect_pem_certificates_many`, `collect_pem_certificates`, `create_client`, `new_default`, `new`, `parse_private_key`, `webpki_root_certs`
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `DynamicDnsSettings`, `DynamicResolver`, `NoVerifier`, `StaticResolver`
