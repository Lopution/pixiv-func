...
class TlsSettings {
  ...
  /// produced by the app's `DohResolver.lookupEchConfig`. When set, the
  /// TLS client uses rustls `EchMode::Enable` (real SNI encrypted, outer
  /// SNI is the ECH front); certificate chain + hostname verification stay
  /// enabled. When null, behavior is identical to upstream rhttp.
